...
import Language.Haskell.TH.Path.Context (ContextM, InstMap, reifyInstancesWithContext)
...
import Language.Haskell.TH.Path.TypeInfo (makeTypeInfo, startTypes, TypeInfo, typeVertex, typeVertex')
import Language.Haskell.TH.Path.Vertex (etype, TGV'(TGV', _vsimple), vsimple, TGVSimple'(TGVSimple', _etype), TGVSimple)
