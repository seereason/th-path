-- | Copy of Data.Graph.Inductive.GraphViz, using Ppr instead of Show.
module Appraisal.Utils.Graph (
    Orient(..),
    graphviz, graphviz'
) where
...
graphviz :: (Graph g, Ppr a, Ppr b) =>    g a b   -- ^ The graph to format
...
graphviz' :: (Graph g, Ppr a, Ppr b) => g a b -> String
