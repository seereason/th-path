{-# LANGUAGE DeriveDataTypeable, TemplateHaskell, TypeFamilies, CPP #-}
...
module Appraisal.Utils.UUID.Internal
    (UUID'(..)
    ,null
    ,nil
    ,fromByteString
...
import Appraisal.Utils.UUID.Builder
...
instance Show UUID' where
    show x = "fromJust (UUID.fromString " ++ show (toString x) ++ ")"
