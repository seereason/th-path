...
instance Path (Map ReportID Report) Int
...
instance Path (Map ReportID Report) ReportStandard
    where type PathType (Map ReportID Report)
...
instance Path Report ReportStandard
    where type PathType Report
...
instance Path ReportIntendedUse ReportIntendedUse
    where type PathType ReportIntendedUse
          ...
          toLens _ = iso id id
instance Path ReportStandard Int
...
instance Path ReportStandard ReportStandard
...
instance Path ReportView ReportStandard
    where type PathType ReportView
...
instance Path ReportMap ReportStandard
    where type PathType ReportMap
